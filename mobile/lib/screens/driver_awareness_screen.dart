  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onVerticalDragEnd: (details) {
        if ((details.primaryVelocity ?? 0) > 380) {
          _dismiss();
        }
      },
      child: Scaffold(
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  _block(
                    'FAIXA DETECTADA EM ${widget.distanceM.round()} METROS',
                    widget.crosswalkName.toUpperCase(),
                  ),
                  const SizedBox(height: 12),
                  _block(
                    'VELOCIDADE ATUAL: ${widget.speedKmh.round()} km/h',
                    'JANELA SEGURA DE APROXIMACAO',
                  ),
                  const Spacer(),
                  Container(
